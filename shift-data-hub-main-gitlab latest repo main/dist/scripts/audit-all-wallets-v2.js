...
async function auditAllWallets() {
    ...
    try {
        ...
        for (const user of usersResult.rows) {
            ...
            const posResult = await pool.query(`SELECT asset, position_size_usd, opened_at
         FROM positions
...
// Run audit
auditAllWallets();
//# sourceMappingURL=audit-all-wallets-v2.js.map