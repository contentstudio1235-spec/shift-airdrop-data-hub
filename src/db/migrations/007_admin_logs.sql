...
CREATE INDEX admin_logs_action ON admin_logs(action);
CREATE INDEX admin_logs_resource_type ON admin_logs(resource_type);
CREATE INDEX admin_logs_resource_id ON admin_logs(resource_type, resource_id);
CREATE INDEX admin_logs_admin_wallet ON admin_logs(admin_wallet);
CREATE INDEX admin_logs_created_at ON admin_logs(created_at DESC);
CREATE INDEX admin_logs_resource_time ON admin_logs(resource_type, created_at DESC);
