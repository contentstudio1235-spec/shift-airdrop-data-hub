...
router.get('/dashboard-stats', async (req, res) => {
    try {
        ...
        const stitchedUsersRes = await (0, pool_1.queryOne)('SELECT COUNT(*) as count FROM users WHERE ga_user_id IS NOT NULL');
       ...
       LIMIT 10`);
        ...
        const fR2Res = await (0, pool_1.queryOne)('SELECT COUNT(*) as count FROM users WHERE (referred_by_code IS NOT NULL OR referred_by_wallet IS NOT NULL) AND ga_user_id IS NOT NULL');
