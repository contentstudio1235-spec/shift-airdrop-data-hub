...
async function checkTokenAmounts() {
    try {
        const result = await pool.query(`SELECT id, asset, token_amount, position_size_usd, price_at_open, opened_at 
       FROM positions 
       WHERE wallet = $1 AND status = 'open'
       ORDER BY opened_at DESC`, ['CR2fyBnGxzJDvqJ8warC6JhK1YBWzhkHeJfRiukpY89Q']);
...
checkTokenAmounts();
//# sourceMappingURL=check-token-amounts.js.map